...
export class InlinePlanApproval {
  ...
  render(): void {
    ...
    this.rootEl.createDiv({ cls: 'codexian-plan-inline-title', text: t('chat.plan.complete') });
    ...
    implementRow.createSpan({ text: t('chat.plan.implement'), cls: 'codexian-ask-item-label' });
    ...
    this.feedbackInput = reviseRow.createEl('input', {
      ...
      placeholder: t('chat.plan.revisePlaceholder'),
    });
