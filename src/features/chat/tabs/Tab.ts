...
import { SubagentStateTracker } from '../services/SubagentStateTracker';
...
export function createTab(options: TabCreateOptions): TabData {
  ...
  const subagentStateTracker = new SubagentStateTracker();
...
export function initializeTabControllers(
  ...
  tab.controllers.streamController = new StreamController({
    ...
    subagentStateTracker: services.subagentStateTracker,
  ...
  tab.controllers.inputController = new InputController({
    ...
    getAgentService: () => tab.service,
    getSubagentStateTracker: () => services.subagentStateTracker,
...
export async function destroyTab(tab: TabData): Promise<void> {
  ...
  tab.services.subagentStateTracker.orphanAllActive();
  tab.services.subagentStateTracker.clear();
