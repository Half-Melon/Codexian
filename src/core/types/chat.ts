 ...
 * Providers set it to their equivalent total.
 *
 * Cache token fields are optional. Feature code should use `contextTokens` for
 * display, not recompute from the cache breakdown.
 */
