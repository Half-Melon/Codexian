...
describe('BangBashModeManager', () => {
  it('should enter bash mode on ! keystroke when input is empty', () => {
    ...
    expect(wrapper.addClass).toHaveBeenCalledWith('codexidian-input-bang-bash-mode');
  });
  ...
  it('should remove bash mode class and restore placeholder on destroy()', () => {
    ...
    expect(wrapper.removeClass).toHaveBeenCalledWith('codexidian-input-bang-bash-mode');
