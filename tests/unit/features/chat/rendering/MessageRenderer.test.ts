...
import { renderStoredSubagent } from '@/features/chat/rendering/SubagentRenderer';
...
function mockCapabilities(providerId: 'codex' = 'codex') {
  return () => ({
    providerId,
    supportsPersistentRuntime: true,
    supportsNativeHistory: providerId === 'codex',
...
function createRenderer(messagesEl?: any, providerId: 'codex' = 'codex') {
    ...
    const msg: ChatMessage = {
      ...
      toolCalls: [
        ...
        { id: 'read', name: 'Read', input: { file_path: 'notes/test.md' } } as any,
        {
          ...
          input: { message: 'Inspect notes/test.md' },
          status: 'running',
        } as any,
      ],
      contentBlocks: [
