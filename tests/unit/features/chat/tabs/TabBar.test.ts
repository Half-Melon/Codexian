...
describe('TabBar', () => {
  describe('constructor', () => {
    it('should add tab badges class to container', () => {
      ...
      expect(containerEl._classList.has('codexidian-tab-badges')).toBe(true);
    });
  });
  ...
  describe('badge rendering', () => {
    ...
    it('should set a provider attribute for per-tab streaming colors', () => {
      ...
      tabBar.update([createTabBarItem({ providerId: 'codex' })]);

      expect(containerEl._children[0].getAttribute('data-provider')).toBe('codex');
    });
  });
  ...
  describe('badge state classes', () => {
    it('should apply idle class for inactive tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-idle')).toBe(true);
    });
    ...
    it('should apply active class for active tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-active')).toBe(true);
    });
    ...
    it('should apply streaming class for streaming tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-streaming')).toBe(true);
    });
    ...
    it('should apply attention class for tab needing attention', () => {
      ...
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-attention')).toBe(true);
    });
    ...
    it('should prioritize active over attention', () => {
      ...
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-active')).toBe(true);
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-attention')).toBe(false);
    });
    ...
    it('should prioritize attention over streaming', () => {
      ...
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-attention')).toBe(true);
      expect(containerEl._children[0]._classList.has('codexidian-tab-badge-streaming')).toBe(false);
    });
  ...
  describe('destroy', () => {
    ...
    it('should remove tab badges class from container', () => {
      ...
      expect(containerEl._classList.has('codexidian-tab-badges')).toBe(false);
    });
  });
});
