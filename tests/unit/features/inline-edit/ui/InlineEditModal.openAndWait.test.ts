    ...
    try {
      ...
      const plugin = {
        ...
        getView: jest.fn().mockReturnValue({
          getActiveTab: jest.fn().mockReturnValue({
            conversationId: null,
            draftModel: 'codex:openai/gpt-5.4',
            providerId: 'codex',
            service: {
              getAuxiliaryModel: jest.fn().mockReturnValue('codex:openai/gpt-5.4'),
              providerId: 'codex',
            },
          }),
        }),
      ...
      expect(providerSpy).toHaveBeenCalledWith(plugin, 'codex');
      expect(inlineEditService.setModelOverride).toHaveBeenCalledWith('codex:openai/gpt-5.4');
